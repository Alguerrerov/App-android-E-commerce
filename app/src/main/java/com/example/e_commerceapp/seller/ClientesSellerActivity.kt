...
import com.example.e_commerceapp.model.ClienteSeller
import com.example.e_commerceapp.model.ClientesSellerAdapter
import com.example.e_commerceapp.model.PedidoResumen
...
class ClientesSellerActivity : AppCompatActivity() {
    ...
    private val clienteSeller = listOf(
        ClienteSeller(
            "Juan Pérez", "Pérez Gómez", "juan.perez@gmail.com", "987 654 321",
        ...
        ClienteSeller(
            "Luis Martínez", "Martínez Cruz", "luis.martinez@gmail.com", "933 444 555",
            "55667788", "30 Dic 1985", "Av. Brasil 654, Lima", "Visa •••• 4242",
            "Activo", "Cliente desde: 01 Abr 2024",
            listOf(
                PedidoResumen(
                    "#PED-1054",
                    "14 May 2024 · 06:30 p.m.",
                    2,
                    "S/ 160.00",
                    "Entregado"
                )
